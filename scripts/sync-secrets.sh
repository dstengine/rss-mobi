...
VERCEL=(MONGODB_CONNECTION_STRING MONGODB_DB CRON_SECRET INDEXNOW_KEY TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID
  DATAFORSEO_LOGIN DATAFORSEO_PASSWORD GSC_SERVICE_ACCOUNT ANTHROPIC_API_KEY)
